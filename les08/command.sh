...
echo -e "Hello\tout\tthere" # tab command is not working in bash

# The read statement
read -pr var1 var2 var3
read -pr num string junk # More tokens then variables
#134 bye93; alk the rest of the line is put in 'junk'
read -pr token1 token2 #<enter>
